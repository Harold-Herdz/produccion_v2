        ...
        <div class="resumen-mes1">
            ...
            <p>
                ...
                <?php if(!empty($top_maquina_mes1['total']) && $top_maquina_mes1['total'] > 0){ ?>
                    (<?php echo number_format($top_maquina_mes1['total']); ?> paquetes)
                <?php } ?>
            </p>
            <p>
                👷 Mejor operario: <?php 
        ...
        <div class="resumen-mes2">
            ...
            <p>
                ...
                <?php if(!empty($top_maquina_mes2['total']) && $top_maquina_mes2['total'] > 0){ ?>
                    (<?php echo number_format($top_maquina_mes2['total']); ?> paquetes)
                <?php } ?>
            </p>
            <p>
                👷 Mejor operario: <?php 
...
<div class="overlay" id="modalImportar">
    <div class="modal">  
        ...
        <div class="btn-row">
            <a class="btn-nuevos" href="<?= BASE_URL ?>/import/controllers/imp_sellado.php?modo=nuevos">
                <div class="btn-text"><span class="btn-icon">🗲</span>Importar Nuevos<span class="btn-arrow">›</span></div>
            </a>
            <a class="btn-todo" href="<?= BASE_URL ?>/import/controllers/imp_sellado.php?modo=todo">
...
<script src="<?= BASE_URL ?>/modules/sellado/scripts/dashboard.js"></script>
