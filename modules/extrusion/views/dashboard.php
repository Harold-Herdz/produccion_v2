...
<div class="overlay" id="modalImportar">
    <div class="modal">
        ...
        <div class="btn-row">
            <a class="btn-nuevos" href="<?= BASE_URL ?>/import/controllers/imp_extrusion.php?modo=nuevos" >
                <div class="btn-text"><span class="btn-icon">🗲</span>Importar Nuevos<span class="btn-arrow">›</span></div>
            </a>
            <a class="btn-todo" href="<?= BASE_URL ?>/import/controllers/imp_extrusion.php?modo=todo" >
