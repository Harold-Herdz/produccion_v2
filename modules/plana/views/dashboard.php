...
<div class="container">
    <!-- Título -->
    <h2 class="titulo-vista">Producción de Máquina Plana</h2>
        ...
        <div class="resumen-mes1">
            ...
            <p>
                ...
                echo $peso_rollo_mes1 !== null
                    ? number_format($peso_rollo_mes1).' kg'
                    : 'Sin datos';
                ?>
            </p>
            <p>
                ...
                echo $peso_retal_mes1 !== null
                    ? number_format($peso_retal_mes1).' kg'
                    : 'Sin datos';
                ?>
            </p>
            <p>
            ...
            <p>
                💰 Cantidad Bultos: <?php 
                echo $bultos_mes1 !== null 
                    ? number_format($bultos_mes1).' bultos' 
                    : 'Sin datos'; 
                ?>
            </p>
            <p>
        ...
        <div class="resumen-mes2">
            ...
            <p>
                ...
                echo $peso_rollo_mes2 !== null
                    ? number_format($peso_rollo_mes2).' kg'
                    : 'Sin datos';
                ?>
            </p>
            <p>
                ...
                echo $peso_retal_mes2 !== null
                    ? number_format($peso_retal_mes2).' kg'
                    : 'Sin datos';
                ?>
            </p>
            <p>
            ...
            <p>
                💰 Cantidad Bultos: <?php 
                echo $bultos_mes2 !== null 
                    ? number_format($bultos_mes2).' bultos' 
                    : 'Sin datos'; 
                ?>
            </p>
            <p>
    ...
    <div class="contenedor-grafico">
        <h3>Peso por año (Máquina Plana)</h3>
    ...
    <div class="tabla-dashboard">
        ...
        <table>
            ...
            ?>
            <tr>
                <td><?php echo $row['nombre_referencia_esp']; ?></td>
                <td><?php echo number_format($row['peso_rollo'],2); ?></td>
                <td><?php echo number_format($row['peso_retal'],2); ?></td>
                <td><?php echo number_format($row['bultos']); ?></td>
                <td><?php echo number_format($row['peso_total'],2); ?></td>
...
<div class="overlay" id="modalImportar">
    <div class="modal">
        ...
        <div class="btn-row">
            <a class="btn-nuevos" href="<?= BASE_URL ?>/import/controllers/imp_plana.php?modo=nuevos" >
                <div class="btn-text"><span class="btn-icon">🗲</span>Importar Nuevos<span class="btn-arrow">›</span></div>
            </a>
            <a class="btn-todo" href="<?= BASE_URL ?>/import/controllers/imp_plana.php?modo=todo" >
...
<script src="<?= BASE_URL ?>/modules/plana/scripts/dashboard.js"></script>
